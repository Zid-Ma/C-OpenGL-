...
private:
    ...
    Mesh processMesh(aiMesh* mesh, const aiScene* scene)
    {
        ...
        // 1. diffuse maps
        vector<Texture> diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");//aiTextureType_AMBIENT//aiTextureType_DIFFUSE
...
//图像读取
//---------
unsigned char* Image_1(const char* path, int* width, int* height,int a = 0, int b = 0) {
    return stbi_load(path, width, height, &a, 0);
}
