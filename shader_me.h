...
#pragma endregion
    ...
    Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr)
    {
        ...
        {
            std::cout << "错误：着色器无法正确读取文件" << vertexPath << fragmentPath << std::endl; //ERROR::SHADER::FILE_NOT_SUCCESFULLY_READ
        }

        std::cout << "最后的编译" << std::endl;
    ...
    void checkCompileErrors(GLuint shader, std::string type)
    {
        ...
        if (type != "PROGRAM")
        {
            ...
            if (!success)
            {
                ...
                std::cout << "错误：：着色器编译错误,类型： " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;//ERROR::SHADER_COMPILATION_ERROR of type :
            }
        }
        else
        {
            ...
            if (!success)
            {
                ...
                std::cout << "错误：：程序链接错误,类型：" << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;//ERROR::PROGRAM_LINKING_ERROR of type: 
            }
        }
    }
};
